  ...
  return (
    <div
      className={`
        ...
        h-screen bg-neutral-50 dark:bg-neutral-800 text-black dark:text-white
      ...
      <div className="mb-8 relative">
        ...
        <Button
          ...
          className={`
            ...
            ${isCollapsed 
              ? 'absolute -right-10 top-6 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-b-md shadow-lg z-10' 
